  ...
  export const doctorAvailabilityMock: DoctorAvailability[] = [
    ...
    },
    {
      ...
      availability: [
        ...
        { date: "2026-02-05", periods: [{ start: "09:00", end: "11:30" }, { start: "14:00", end: "17:00" }, { start: "17:30", end: "20:30" }] },
        { date: "2026-02-06", periods: [{ start: "09:00", end: "11:30" }, { start: "14:00", end: "17:00" }, { start: "17:30", end: "20:30" }] },
        { date: "2026-02-07", periods: [{ start: "09:00", end: "11:30" }, { start: "13:00", end: "17:00" }] },
      ],
    },
    // ===== MARÇO 2026 =====
  ];
